...
load_balancer_module=LoadBalancerModule(self,"LbModule", vpc=vpc_module.vpc, public_server_1=ec2_module.public_server_1, public_server_2=ec2_module.public_server_2)
